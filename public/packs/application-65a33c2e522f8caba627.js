...
var map = {
	...
	"./demo-controller.js": 35,
	"./drag_item_controller.js": 36,
	"./modal-controller.js": 37
};
...
throw new Error("Module build failed: SyntaxError: Unexpected token (23:42)\n\n  21 |     const dropTarget = event.target\n  22 |     const draggedItem = this.element.querySelector(`[data-todo-id='${data}']`);\n> 23 |     const positionComparison = dropTarget/.compareDocumentPosition(draggedItem)\n     |                                           ^\n  24 |     if (positionComparison & 4) {\n  25 |       event.target.insertAdjacentElement('beforebegin', draggedItem);\n  26 |     } else if ( positionComparison & 2 ) {\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-65a33c2e522f8caba627.js.map