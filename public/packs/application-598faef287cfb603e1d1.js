...
var map = {
	...
	"./modal-controller.js": 39,
	"./select_filter_controller.js": 40
};
  ...
  _createClass(_class, [{
    ...
    value: function change(event) {
      ...
      fetch(this.data.get("url"), {
        method: 'POST',
        body: JSON.stringify({ groups: [].concat(_toConsumableArray(event.target.selectedOptions)).map(function (option) {
            return option.value;
          }) }),
        credentials: "include",
        dataType: 'script',
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-598faef287cfb603e1d1.js.map